...
var whiteKeyInstance : Transform;
...
function DropObject () {
	...
	if (currentlyHolding == "White Key") {
		whiteKeyInstance = Instantiate (whiteKey, instantiationPoint.position, instantiationPoint.rotation);
		whiteKeyInstance.transform.parent = movingObjects.transform;
		whiteKeyHand.gameObject.SetActive(false);
...
function OnTriggerEnter (other : Collider) {
	...
	if (ready) {
		...
		if (other.tag == "White Key") {
			...
			yellowKeyHand.gameObject.SetActive(false);
			blackKeyHand.gameObject.SetActive(false);
			whiteKeyHand.gameObject.SetActive(true);
			swordHand.gameObject.SetActive(false);
			magnetHand.gameObject.SetActive(false);
			chaliceHand.gameObject.SetActive(false);
			AudioSource.PlayClipAtPoint(pickupSound,transform.position);
